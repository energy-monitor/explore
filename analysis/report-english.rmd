...
###load last observed gas consumption data too
###
d.recent.cons = loadFromStorage("consumption-gas-aggm") |> 
    filter(date > max(d.eval$date)) |> 
    mutate(variable = "gas.cons") |> 
...
d.eval.recent = d.eval |> 
    bind_rows(d.recent.cons) |> 
