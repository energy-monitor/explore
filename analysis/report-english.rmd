...
<!--
Todo:
- storage calculation in last table is somehow wrong. Scenario stor.w.russia should be higher than the others.
...
d.all.years %>%
    ...
    ggplot(aes(x = date, y = value)) +
        geom_line(aes(col = Klima, linetype = as.character(year)), size = 0.1, alpha = 0.6) +
        facet_wrap(. ~ variable) +
        geom_abline(slope = 0, intercept = storage.start.strategic, linetype = 2) +
        geom_smooth(aes(col = Klima)) +
