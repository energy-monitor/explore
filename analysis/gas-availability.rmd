...
d.all.years %>%
    ...
    ggplot(aes(x = date, y = value)) +
        ...
        ylim(c(0, l.gas.info$l.storage$strategic + l.gas.info$l.storage$d.domestic.last$level + 2)) +
