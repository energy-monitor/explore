...
d.all.years %>%
    ...
    mutate(Klimajahr = ifelse(year < 2000, "vor 2000", "nach 2000")) %>% 
    ggplot(aes(x = date, y = value)) +
        geom_line(aes(col = Klimajahr, linetype = as.character(year)), linewidth = 0.6, alpha = 0.5) +
        facet_wrap(. ~ variable) +
        ...
        scale_linetype_manual(values = 1:72, guide = "none") +
