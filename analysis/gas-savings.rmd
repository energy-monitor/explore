...
In Summe wird in Österreich seit Mitte Juli von Haushalten und Industrie also Gas gespart - in einzelnen Monaten sogar bis zu 16%. Die absoluten Einsparungen im Vergleich zum Vorjahr, im Vergleich zur Periode 2019-2021 sind unten dargestellt - und daneben sind die witterungsbereinigten Einsparungen dargestellt - einmal ohne die Stromproduktion zu berücksichtigen (Variante 1) und einmal inklusive Stromproduktion.
