...
<p style="color: red;">Diese Seite wurde nur bis Ende 2024 aktualisiert, weil der langfristige Trend im Gasverbrauch in der Schätzung mit zunehmendem Abstand von der Trainingsperiode stärker wirkt als kurzfristige Einsparungen. In unserer Analyse nutzen wir eine Gleichung, bei der die Zeit linear und quadratisch eingeht. Für die Jahre 2015 bis 2021 zeigt die Analyse, dass der Verbrauch langfristig sinken wird, unabhängig von kurzfristigen Einsparungen. Je weiter wir uns vom Jahr 2021 entfernen, desto mehr dominiert dieser langfristige Trend. Deshalb hören wir Ende 2024 auf, die Einsparungseffekte zu berechnen.</p>
