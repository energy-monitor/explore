...
knitr::opts_chunk$set(echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=3, dpi=300)
...
d.pred.non.economic %>% 
    ...
    ggplot(aes(x = date, y = value)) +
        ...
        xlab(NULL) + ylab("Täglicher Gasverbrauch \n (TWh, 14-tägiges Mittel)")
```
...
d.pred.non.economic %>%
    ...
    ggplot(aes(x = date, y = difference)) +
        ...
        xlab(NULL) + ylab("Relative Differenz zwischen \nSchätzung und Observation\n in %") +
...
relative.savings.no.power %>% 
    ...
    ggplot(aes(x = Gasverbrauch, y = rel.save)) +
        ...
        theme_bw() + xlab(NULL) + 
        ylab("Veränderungen im Vergleich zu 2019 - 2021 \n (%) ")
```
